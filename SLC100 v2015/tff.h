...
typedef struct _FATFS{
	...
	BYTE 	win[800];		/* Disk access window for Directory/FAT/File */
}FATFS;
...
FRESULT f_open (FIL*, const char*path, BYTE);			/* Open or create a file */
FRESULT f_read (FIL*, void*buff, UINT, UINT*);			/* Read data from a file */
FRESULT f_write (FIL*, const void*buff, UINT, UINT*);	/* Write data to a file */
...
int f_puts (const char*str, FIL*);						/* Put a string to the file */
