...
#if boxNumber == 1//
// **** Tu so 1 *********************************   
int offsetVol[3] = {-307,-552,-588};
int offsetAmp[3] = {-135,-135,-135};
int wattGain[3]  = {0,0,0};
#endif
//***********************************************
#if boxNumber == 2//
// **** Tu so 2 *********************************   
int offsetVol[3] = {-112,-132,-112};
...
#if boxNumber == 29//
// **** Tu so 29 *********************************   
int offsetVol[3] = {-876,-730,-296};
int offsetAmp[3] = {-147,-152,-150	};
int wattGain[3]  = {0,0,0};
#endif
//***********************************************
#if boxNumber == 30//
